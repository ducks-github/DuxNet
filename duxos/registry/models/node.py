...
class NodeHealth:
    ...
    def update(
        ...
        self.is_healthy = (
            self.load_average < 2.0 and self.memory_usage < 90.0 and self.disk_usage < 90.0
        )
...
class Node:
    ...
    def update_health(self, load_average: float, memory_usage: float, disk_usage: float) -> None:
        ...
        self.health.is_healthy = load_average < 2.0 and memory_usage < 90.0 and disk_usage < 95.0
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "duxos_version": self.duxos_version,
            "capabilities": {
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Node":
        ...
        node = cls(
            ...
            duxos_version=data.get("duxos_version", ""),
        )
