...
class MetadataStorage:
    ...
    def _update_service_index(self, service_id: str, content_hash: str, metadata: Dict[str, Any]) -> None:
    ...
    def _update_reviews_index(self, service_id: str, content_hash: str, count: int) -> None:
    ...
    def _update_rating_index(self, service_id: str, content_hash: str) -> None:
        """Update rating index"""
