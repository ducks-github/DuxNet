...
class MainWindow(QMainWindow):
    ...
    def handle_install_request(self, service_id):
        ...
        QMessageBox.information(self, "Install Service", f"Installation requested for service {service_id}")
        # TODO: Implement actual installation logic
    
    def handle_invoke_request(self, service_id):
        """Handle service invocation request"""
        QMessageBox.information(self, "Invoke Service", f"API invocation requested for service {service_id}")
    ...
    def show_about(self):
        """Show about dialog"""
        QMessageBox.about(self, "About DuxOS Desktop", 
                         "DuxOS Desktop v1.0\n\n"
