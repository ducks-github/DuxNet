...
class NodeReputationService:
    ...
    def set_registry_service(self, registry_service):
        """Set the registry service instance."""
        self.registry_service = registry_service
    
    def update_reputation(self, node_id: str, event_type: ReputationEventType, 
                         custom_delta: float | None = None) -> Dict[str, Any]:
        """
        ...
        try:
            result = self.registry_service.update_node_reputation(node_id, delta)
    ...
    def add_custom_rule(self, event_type: ReputationEventType, delta: float):
        """Add or update a custom reputation rule."""
        self.reputation_rules[event_type] = delta
    
    def remove_rule(self, event_type: ReputationEventType):
