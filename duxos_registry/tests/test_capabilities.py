...
from services.registry import NodeRegistryService, CapabilityType
from api.schemas import (
    CapabilityAddRequest, CapabilityRemoveRequest, CapabilityUpdateRequest, 
    CapabilityResponse, CapabilityQueryRequest, CapabilityStatisticsResponse,
...
class TestCapabilityManagement:
    ...
    def setup_method(self):
        ...
        self.registry_service.register_node("compute_node", "192.168.1.100:8000", ["compute", "storage"])
        self.registry_service.register_node("gpu_node", "192.168.1.101:8000", ["compute", "gpu", "ai_ml"])
        self.registry_service.register_node("storage_node", "192.168.1.102:8000", ["storage", "database"])
        self.registry_service.register_node("network_node", "192.168.1.103:8000", ["network", "security"])
    
    def test_register_node_with_capabilities(self):
        """Test registering a node with capabilities."""
        result = self.registry_service.register_node("test_node", "192.168.1.200:8000", ["compute", "custom_capability"])
    ...
    def test_add_node_capabilities_duplicate(self):
        ...
        result = self.registry_service.add_node_capabilities("compute_node", ["compute", "new_capability"])
    ...
    def test_remove_node_capabilities_nonexistent(self):
        ...
        result = self.registry_service.remove_node_capabilities("compute_node", ["nonexistent_capability"])
    ...
    def test_update_node_capabilities(self):
        ...
        result = self.registry_service.update_node_capabilities("storage_node", ["web_server", "security"])
    ...
    def test_get_nodes_by_capabilities_any(self):
        ...
        nodes = self.registry_service.get_nodes_by_capabilities(["gpu", "database"], match_all=False)
    ...
    def test_get_nodes_by_capabilities_all(self):
        ...
        nodes = self.registry_service.get_nodes_by_capabilities(["compute", "storage"], match_all=True)
    ...
    def test_get_nodes_by_capabilities_all_nonexistent(self):
        ...
        nodes = self.registry_service.get_nodes_by_capabilities(["compute", "nonexistent"], match_all=True)
        assert nodes == []
    ...
    def test_get_available_capabilities(self):
        ...
        expected_capabilities = ["compute", "storage", "gpu", "ai_ml", "database", "network", "security"]
    ...
    def test_validate_capability_invalid(self):
        ...
        assert self.registry_service.validate_capability("invalid@capability") is False  # special char
...
class TestCapabilitySchemas:
    ...
    def test_capability_remove_request(self):
        ...
        request = CapabilityRemoveRequest(
            node_id="test_node",
            capabilities_to_remove=["compute", "gpu"]
        )
    ...
    def test_capability_update_request(self):
        ...
        request = CapabilityUpdateRequest(
            node_id="test_node",
            new_capabilities=["compute", "gpu", "storage"]
        )
