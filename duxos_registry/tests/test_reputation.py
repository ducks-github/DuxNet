...
class TestNodeRegistryService:
    ...
    def setup_method(self):
        ...
        self.registry_service.register_node(
            "test_node_1", "192.168.1.100:8000", ["compute", "storage"]
        )
...
class TestNodeReputationService:
    ...
    def test_update_reputation_task_success(self):
        ...
        result = self.reputation_service.update_reputation(
            "test_node_1", ReputationEventType.TASK_SUCCESS
        )
    ...
    def test_update_reputation_task_failure(self):
        ...
        result = self.reputation_service.update_reputation(
            "test_node_1", ReputationEventType.TASK_FAILURE
        )
    ...
    def test_update_reputation_malicious_behavior(self):
        ...
        result = self.reputation_service.update_reputation(
            "test_node_1", ReputationEventType.MALICIOUS_BEHAVIOR
        )
    ...
    def test_update_reputation_custom_delta(self):
        ...
        result = self.reputation_service.update_reputation(
            "test_node_1", ReputationEventType.TASK_SUCCESS, custom_delta=25.0
        )
    ...
    def test_update_reputation_node_not_found(self):
        """Test error handling for non-existent node."""
        result = self.reputation_service.update_reputation(
            "nonexistent_node", ReputationEventType.TASK_SUCCESS
        )
...
class TestReputationAPI:
    ...
    def test_update_reputation_success(self):
        ...
        response = self.client.post(
            "/nodes/reputation", json={"node_id": "api_test_node", "event_type": "task_success"}
        )
    ...
    def test_update_reputation_custom_delta(self):
        ...
        response = self.client.post(
            "/nodes/reputation",
            json={"node_id": "api_test_node", "event_type": "task_success", "custom_delta": 25.0},
        )
    ...
    def test_update_reputation_invalid_event_type(self):
        ...
        response = self.client.post(
            "/nodes/reputation", json={"node_id": "api_test_node", "event_type": "invalid_event"}
        )
    ...
    def test_update_reputation_node_not_found(self):
        """Test error handling for non-existent node."""
        response = self.client.post(
            "/nodes/reputation", json={"node_id": "nonexistent_node", "event_type": "task_success"}
        )
    ...
    def test_update_reputation_missing_node_id(self):
        ...
        response = self.client.post("/nodes/reputation", json={"event_type": "task_success"})

        assert response.status_code == 422  # Validation error

    def test_update_reputation_missing_event_type(self):
        """Test error handling for missing event_type."""
        response = self.client.post("/nodes/reputation", json={"node_id": "api_test_node"})
    ...
    def test_all_event_types(self):
        ...
        for event_type in event_types:
            response = self.client.post(
                "/nodes/reputation", json={"node_id": "api_test_node", "event_type": event_type}
            )
...
class TestReputationSchemas:
    ...
    def test_reputation_update_request_valid(self):
        ...
        request = ReputationUpdateRequest(
            node_id="test_node", event_type="task_success", custom_delta=15.0
        )
    ...
    def test_reputation_update_request_optional_custom_delta(self):
        ...
        request = ReputationUpdateRequest(node_id="test_node", event_type="task_success")
