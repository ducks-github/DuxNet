...
class TestNodeReputationService:
    ...
    def test_all_event_types(self):
        ...
        event_types = [
            ...
            ReputationEventType.TASK_TIMEOUT,
            ReputationEventType.MALICIOUS_BEHAVIOR,
            ReputationEventType.HEALTH_MILESTONE,
            ReputationEventType.UPTIME_MILESTONE,
            ReputationEventType.COMMUNITY_CONTRIBUTION,
        ]

        for event_type in event_types:
            result = self.reputation_service.update_reputation("test_node_2", event_type)
