...
class MainWindow(QMainWindow):
    def __init__(self, api_client, wallet_client=None, *args, **kwargs):
        ...
        self.advanced_features_tab = AdvancedFeaturesTab(self.api_client, self.wallet_client)
        self.advanced_features_tab.setVisible(False)  # Initially hidden
        layout.addWidget(self.advanced_features_tab)
    ...
    def setup_menu_bar(self):
        ...
        advanced_action = QAction("Advanced Features", self)
        advanced_action.setCheckable(True)
        advanced_action.triggered.connect(self.toggle_advanced_features)
    ...
    def toggle_advanced_features(self, checked):
        """Toggle advanced features visibility"""
        self.advanced_features_tab.setVisible(checked)
        if checked:
            QMessageBox.information(self, "Advanced Features", 
                "Advanced features enabled! You can now access:\n"
