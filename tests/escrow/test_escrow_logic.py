...
from duxos_escrow.models import Base, EscrowStatus, DisputeStatus
...
def db_session():
    ...
    engine = create_engine("sqlite:///test_escrow_logic.db", connect_args={"check_same_thread": False})
