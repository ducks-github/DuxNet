...
def client(mock_governance_manager):
    ...
    from duxos_escrow.governance_api import get_governance_manager, governance_manager
    ...
    with patch(
        "duxos_escrow.governance_api.get_governance_manager", return_value=mock_governance_manager
    ):
...
class TestGovernanceAPI:
    ...
    def test_create_proposal_success(
        self, client, mock_governance_manager, sample_proposal_data, sample_proposal
    ):
    ...
    def test_create_proposal_validation_error(
        self, client, mock_governance_manager, sample_proposal_data
    ):
    ...
    def test_get_proposals_by_status(self, client, mock_governance_manager, sample_proposal):
        ...
        mock_governance_manager.get_proposals_by_status.assert_called_once_with(
    ...
    def test_get_proposals_by_category(self, client, mock_governance_manager, sample_proposal):
        ...
        mock_governance_manager.get_proposals_by_category.assert_called_once_with(
            ProposalCategory.COMMUNITY_FUND
        )
    ...
    def test_get_proposal_not_found(self, client, mock_governance_manager):
        ...
        mock_governance_manager.get_proposal.side_effect = ProposalNotFoundError(
            "Proposal not found"
        )
    ...
    def test_get_vote_results_not_found(self, client, mock_governance_manager):
        ...
        mock_governance_manager.get_vote_results.side_effect = ProposalNotFoundError(
            "Proposal not found"
        )
