...
from duxos_registry.db.repository import (
    NodeRepository,
    TransactionRepository,
    WalletRepository,
)
from duxos_registry.main import app
from duxos_registry.models.database_models import Node, Transaction, Wallet
...
class TestWalletService:
    ...
    def test_create_wallet_success(self, mock_rpc, db_session, sample_node_data):
        ...
        result = wallet_service.create_wallet(
            node_id=sample_node_data["node_id"], wallet_name="test_wallet"
        )
    ...
    def test_create_wallet_already_exists(self, mock_rpc, db_session, sample_node_data):
        ...
        result2 = wallet_service.create_wallet(
            node_id=sample_node_data["node_id"], wallet_name="test_wallet2"
        )
...
class TestWalletAPI:
    ...
    def test_create_wallet_api(self, setup_database, sample_node_data):
        ...
        # Create wallet
        wallet_data = {"node_id": sample_node_data["node_id"], "wallet_name": "test_wallet"}

        with patch(
            "duxos_registry.services.wallet_service.WalletService._make_rpc_call"
        ) as mock_rpc:
            mock_rpc.return_value = ("FLOP123456789abcdef", None)
    ...
    def test_send_transaction_api(self, setup_database, sample_node_data):
        ...
        with patch(
            ...
            send_response = client.post(
                f"/wallet/{sample_node_data['node_id']}/send", json=transaction_data
            )
